  ...
  return (
    singleProduct && (
      <div>
            ...
            >
              <div
                ...
                style={{
                  ...
                  backgroundSize: zoomStyle.backgroundPosition
                    ? "200%"
                    : "contain",
                  ...zoomStyle,
                }}
            ...
            {hasVariants ? (
              <>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 w-fit">
                  {[...new Set(singleProduct.variants.map((v) => v.color))].map(
                    (color, index) => (
                      <div
                        key={index}
                        ...
                        className={`w-fit p-2 border cursor-pointer rounded mt-2 transition-all duration-300 ${
                          selectedColor === color
                            ...
                            : "border-blue-200 hover:bg-white hover:text-blue-950"
                        }`}
                      >
        ...
        <div className="my-12 mb-18 sm:px-12 lg:px-8 xl:px-16 px-4">
      <OurValues />
      </div>
      </div>
    )
