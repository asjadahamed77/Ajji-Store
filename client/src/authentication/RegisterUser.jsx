...
const RegisterUser = () => {
  ...
  const handleOtpSubmit = async (e) => {
    ...
    if (verifyEmail.fulfilled.match(result)) {
      ...
      toast.error(
        "Verification failed. Your account has been removed. Please register again."
      );
      navigate("/login");
    }
  };
      ...
      {showOtpPopup && (
        <div className="fixed inset-0  backdrop-blur-3xl flex items-center justify-center z-50">
          <div className="bg-transparent  p-6 rounded-lg shadow-lg w-[350px]">
            ...
            <p className="text-sm text-center text-blue-100 mb-4">
            ...
            >
              ...
              <button
                type="submit"
                className="mt-4 bg-blue-900 text-white px-4 py-1 rounded hover:opacity-80"
              >
                Verify Email
              </button>
            </form>
